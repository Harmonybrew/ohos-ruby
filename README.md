...
cd /root
curl -L -O https://github.com/Harmonybrew/ohos-ruby/releases/download/4.0.1/ruby-4.0.1-ohos-arm64.tar.gz
tar -zxf ruby-4.0.1-ohos-arm64.tar.gz -C /opt
...
需要在 [鸿蒙容器](https://github.com/hqzing/docker-mini-openharmony) 中运行项目里的 build.sh，以实现 ruby 的本地编译。
